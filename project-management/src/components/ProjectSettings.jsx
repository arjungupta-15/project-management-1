                    ...
                    {(project.members?.length > 0) && (
                        <div className="space-y-2 mt-2 max-h-32 overflow-y-auto">
                            {project.members.map((member, index) => (
                                <div key={member?._id || index} className="flex items-center justify-between px-3 py-2 rounded dark:bg-zinc-800 text-sm text-zinc-900 dark:text-zinc-300">
                                    <div className="flex items-center gap-2">
                                        {member?.image ? (
                                            <img src={member.image} className="size-5 rounded-full" alt="" />
                                        ) : (
                                    ...
                                    {project.team_lead?._id === member?._id && (
                                        <span className="text-xs px-2 py-0.5 rounded ring ring-zinc-200 dark:ring-zinc-600">Lead</span>
                                    )}
                                </div>
                            ))}
                        </div>
